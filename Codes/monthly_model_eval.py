...
def parse_args():
    ...
    parser.add_argument('--treatment-pred-file', type=str, default='treatment_output.csv') 
    parser.add_argument('--clinic-pred-file', type=str, default='clinic_output.csv')
...
if __name__ == "__main__":
    ...
    treatment_pred_file = args.treatment_pred_file
    clinic_pred_file = args.clinic_pred_file
    ...
    pred_file_map = {'treatment': treatment_pred_file, 'clinic': clinic_pred_file}
    ...
    for anchor in ['treatment', 'clinic']:
        ...
        df = pd.read_csv(f'{ROOT_DIR}/{pred_file}', parse_dates=[date_col])
