...
# A2R_EPIC_GI_regimen_map = pd.read_excel(info_data_path + '/A2R_EPIC_GI_regimen_map.xlsx')
...
def get_treatment_data(
    ...
    df = filter_treatment_data(df, drugs, regimens) #drugs,
